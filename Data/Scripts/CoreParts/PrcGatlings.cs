    ...
    partial class Parts {
        ...
        WeaponDefinition SmallPrecursorAntiElectronWep => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "SmallPrecursorAntiElectron", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "Small Fixed Zei'a Anti-Electron Caster", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                AntiElectronAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
